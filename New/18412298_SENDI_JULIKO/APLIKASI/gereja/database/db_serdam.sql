...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2023 at 05:04 PM
...
CREATE TABLE `tbberita` (
  ...
  `gambarCover` text NOT NULL,
  `fileBerita` text NOT NULL,
...
(2, 'IBADAH UMUM 1 DAN 2', 'TEMA: HUKUM DAN KEBENARAN\r\nOleh: Pdt. Heng Ci Kiang\r\n\r\nMinggu, 09 Juli 2023', '64ae354c69d31.jpg', '', 0),
(3, 'IBADAH RAYA', 'TEMA: BERGUMUL DENGAN ALLAH\r\nOleh: Pdt. Seniman Lo\r\n\r\nMinggu, 11 Juni 2023', '64ae358b392f3.jpg', '', 0),
(4, 'IBADAH RAYA 1&2, 13 Agustus 2023', 'Tema: Skandal & Anugrah\r\nOleh: Pdt. Heng Ci Kiang\r\n', '64da4f503ea07.jpg', '', 0),
(5, 'IBADAH RAYA 1 & 2', 'TEMA: BUAH KEBENCIAN\r\nPEMBICARA: PDT. HENG CI KIANG\r\nTANGGAL:  MINGGU, 06 AGUSTUS 2023', '64daf25687a27.jpg', '', 0);
...
(3, '2023-07-12', 'julikosendi', 'Selam', 'L', '64ae68b42f652.jpg', 1);
...
(1, '2023-07-12', 'niatrisna11', 0, 1, 1),
(2, '2023-07-12', 'julikosendi', 0, 2, 1);
...
CREATE TABLE `tbdaftarpemberkatan` (
  ...
  `lampirSuratBaptis` text NOT NULL,
  `lampirSertifikatPranikah` text NOT NULL,
...
(1, '2023-07-12', 'niatrisna11', 'Sendi Juliko', '2023-07-16', '081258119344', '64adfdd40776b.jpg', 12, 1);
...
(14, 3, 'Sesi 1', 'Minggu', '12:00:00', '14:00:00');
...
('elsendqz', 'Amegafuru1-', 'sendiijuliko@gmail.com', 'Sendi Juliko', 'Laki-Laki', 'Pontianak', '2000-07-20', '089693204888', 'Jl. Teluk Sahang 1 No. 65', 'Kalimantan Barat', 'Pontianak', 'Pontianak Utara', 'Siantan Hilir', '78243', 'Pelajar/Mahasiswa', '2023-04-18'),
('julikosendi', 'hanabi12', 'ssendijuliko@gmail.com', 'Sendy Juliko', 'Laki-Laki', 'Pontianak', '2000-07-20', '089693204888', 'Jl. Teluk Sahang 1 No. 65', 'Kalimantan Barat', 'Pontianak', 'Pontianak Utara', 'Siantan Hilir', '78243', 'Pelajar/Mahasiswa', '2023-07-12'),
('limsendy', 'hanabi12', 'sendi.jco@gmail.com', 'Sendy Juliko', 'Laki-Laki', 'Pontianak', '2000-07-20', '089693204888', 'Jl. Teluk Sahang 1 No. 65', 'Kalimantan Barat', 'Pontianak', 'Pontianak Utara', 'Siantan Hilir', '78242', 'Pelajar/Mahasiswa', '2023-07-12'),
('mchaell_', 'michael', 'michaelaulia@gmail.com', 'Michael Aulia', 'Laki-Laki', 'Pontianak', '2007-12-10', '081258119344', 'Jl. Selat Panjang', 'Kalimantan Barat', 'Pontianak', 'Pontianak Utara', 'Siantan Hulu', '78242', 'Pelajar/Mahasiswa', '2023-07-11'),
...
('niatrisna11', 'niaserdam', 'niatrisna@gmail.com', 'Nia Trisna', 'Perempuan', 'Pontianak', '1998-01-01', '08878374583458', 'Jl. Sungai Raya Dalam', 'Kalimantan Barat', 'Pontianak', 'Pontianak Tenggara', 'Bangka Belitung Barat', '78124', 'Karyawan', '2023-07-12'),
...
--
ALTER TABLE `tbdaftarbaptis`
  MODIFY `idDaftarBaptis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbdaftarpemberkatan`
  MODIFY `idDaftarPemberkatan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbdaftarpranikah`
--
ALTER TABLE `tbdaftarpranikah`
  MODIFY `idDaftarPranikah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbsesikelas`
  MODIFY `idSesiKelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
ALTER TABLE `tbdaftarpemberkatan`
  ...
  ADD CONSTRAINT `tbdaftarpemberkatan_ibfk_2` FOREIGN KEY (`idSesiKelas`) REFERENCES `tbsesikelas` (`idSesiKelas`);
